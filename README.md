...
This is a simple Solidity smart contract that creates a token called "SOL" with the abbreviation "SL". It has a total supply that starts at 0, and uses a mapping of addresses to balances to keep track of how many tokens each address holds.
...
1)The contract has public variables to store the details about the coin: tokenName, tokenAbrv, and totalSupply.
